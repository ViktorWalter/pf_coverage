...
def generate_launch_description():
    ...
    for i in range(0,ROBOTS_NUM):
        n = Node(
            ...
            parameters=[{"ROBOTS_NUM": ROBOTS_NUM}, {"ROBOT_RANGE": ROBOT_RANGE}, {"ROBOT_FOV": ROBOT_FOV}, {"AREA_SIZE_x": AREA_SIZE_x}, {"AREA_SIZE_y": AREA_SIZE_y}, {"AREA_LEFT": AREA_LEFT}, {"AREA_BOTTOM": AREA_BOTTOM}, {"ROBOT_ID": i}, {"MODE": MODE}, {"GOAL_X": xg[i]}, {"GOAL_Y":yg[i]}],
            output='screen')
